...
// This interface isn't needed and was causing type issues
// We'll use a more direct approach with `any` in this case
        ...
        try {
          if (taskData.creatorRef) {
            ...
            if (creatorDoc.exists()) {
              // Firestore data needs type casting
              const creatorData = creatorDoc.data() as CreatorData;
              ...
              if (creatorData.photoURL) {
                creatorPhoto = creatorData.photoURL;
              }
            }
          }
        } catch (error) {
